...
class ROSNode:
    def __init__(self):
        ...
        self.csv_file = open('/home/robot007/mvr_ws/src/mvr_robot_control/data/record_20dof.csv', mode='w', newline='')
...
#         ), dim=-1)   
        ...
        model_relative_path = os.path.join('..', 'model', 'policy_1_20dof.pt')
